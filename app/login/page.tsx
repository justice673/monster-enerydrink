    ...
    return (
        <main className="min-h-screen bg-[#0A0A0E] flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                {/* Background Gradient */}
                <div className="absolute inset-0 bg-gradient-to-br from-green-900/40 via-black to-purple-900/40" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <img
                        ...
                        alt="Monster Energy"
                        className="h-[70%] w-auto object-contain drop-shadow-[0_0_100px_rgba(34,197,94,0.3)] animate-pulse"
                    />
                </div>
                ...
                <div className="absolute bottom-16 left-16 right-16 z-10">
                    <h2 className="text-5xl font-metal-lord text-white uppercase mb-4">
                        Unleash <span className="text-green-400 italic">The Motion</span>
                    </h2>
                    <p className="text-gray-400 text-lg">
                        Sign in to access your account and fuel your journey.
                    </p>
                </div>

                {/* Decorative lines */}
                <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-green-500 via-transparent to-transparent" />
                <div className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-purple-500 to-transparent" />
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
                <div className="w-full max-w-md">
                    ...
                    <h1 className="text-4xl md:text-5xl font-metal-lord text-white uppercase mb-2">
                        Sign <span className="text-green-400 italic">In</span>
                    </h1>
